...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        # loss_avg_all = sum(batch_loss)/len(train_loader.dataset)
        print(f'\nTrain batch mean loss:{loss_avg}')
        list_loss.append(loss_avg)
        # list_all_loss.append(loss_avg_all)
    ...
    plt.savefig('./save/nn_{}_{}_{}.png'.format(args.dataset,
                args.model, args.epochs))
    # plt.figure()
    # plt.plot(range(len(list_all_loss)), list_all_loss)
    # plt.xlabel('epochs')
    # plt.ylabel('train loss all')
    # plt.savefig('./save/allnn_{}_{}_{}.png'.format(args.dataset,
    #             args.model, args.epochs))
